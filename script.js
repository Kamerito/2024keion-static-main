...
const songs = [
    ...
    { title: "群青讃歌,アカシア", artist: "のこったーず", category: "orange" },
    { title: "シンデレラボーイ,DENKOUSEKKA,女神", artist: "からあげどっぐ", category: "orange" },
    { title: "バトンロード,栞", artist: "シークレッツ", category: "orange" },
    { title: "レイメイ", artist: "シリウス", category: "orange" },
    { title: "テレキャスタービーボーイ", artist: "照照様", category: "orange" },
    { title: "God knows...,ギターと孤独と青い惑星", artist: "KOF団", category: "orange" },
    { title: "お勉強しといてよ", artist: "はくちゅうむ", category: "orange" },
    { title: "快晴", artist: "Gnu Brain", category: "orange" },
    { title: "StaRt", artist: "いいえ", category: "orange" },
    { title: "PAiNT it BLACK", artist: "鉄腕BiSH", category: "orange" },
    { title: "ベノム,ヒバナ", artist: "非力ハムスター", category: "orange" },
    { title: "くらべられっ子", artist: "未定", category: "orange" },
    { title: "絆の奇跡", artist: "未定", category: "orange" },
    { title: "夕暮れ沿い、", artist: "未定", category: "orange" },
    { title: "未定", artist: "未定", category: "orange" },
    { title: "灼熱にて純情", artist: "未定", category: "orange" },
    { title: "曖昧劣情lover", artist: "未定", category: "orange" },
    { title: "Stand out fit in", artist: "未定", category: "orange" },
    { title: "心做し,ただ声一つ", artist: "渦潮ぽてと+", category: "orange" },
    { title: "HANABI", artist: "Bocci", category: "orange" },
    { title: "未定", artist: "霞草", category: "orange" },
    { title: "春を待つ feat.倚水", artist: "無", category: "orange" },
    { title: "未定", artist: "未定", category: "orange" },
    { title: "part of me", artist: "未定", category: "orange" },
    { title: "なんか", artist: "未定", category: "orange" },
